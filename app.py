...
cred = credentials.Certificate(
    'iuh-20030021-firebase-adminsdk-jd2os-f0f701b570.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20030021').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "Trường: IUH, Lớp: DHHTTT16C, MSSV: 20002915, Tên: Mã Trung Tín", className="header-title"
                )
            ],
            className="header",
        ),
